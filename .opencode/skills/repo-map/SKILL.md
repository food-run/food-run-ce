---
name: repo-map
description: Understand Food Run path ownership, active rebuild surfaces, and where new work belongs
---
# Repo Map
...
- Identify the first correct home for a change
...
Use this skill before planning or implementing when path placement is unclear.
