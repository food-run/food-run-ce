...
- **Output:** Static HTML/CSS/JS bundles via `bun run build:pages` for the reviewer deployment path
...
- The Pages build targets `/food-run-ce/` and publishes a matching `404.html` shell for SPA route refreshes
